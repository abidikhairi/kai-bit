...
def main(args):
    ...
    model = BiologicalInstructionTuning.load_from_checkpoint(args.ckpt_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str, required=True, help="Model checkpoint file path.")
